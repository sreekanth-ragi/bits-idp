...
import { permissionPolicyModule } from './modules/permission';
...
//Keycloak module for no users in catalog
backend.add(
...
//backend.add(import('@backstage/plugin-catalog-backend-module-permission'));
...
// Add the Catalog Permission module to handle CONDITIONAL results
//backend.add(import('@backstage/plugin-catalog-backend-module-entities-count-permission'));

backend.add(import('@backstage/plugin-permission-backend/alpha'));

// Register your custom policy module
