 ...
 * @public
 */
type UnknownFilterPredicateOperator = {
 ...
 * @public
 */
type FilterPredicate = FilterPredicateExpression | FilterPredicatePrimitive | {
    /**
 ...
 * @public
 */
type FilterPredicateExpression = {
 ...
 * @public
 */
type UnknownFilterPredicateValueMatcher = {
 ...
 * @public
 */
type FilterPredicateValue = FilterPredicatePrimitive | {
    /**
 ...
 * @public
 */
type FilterPredicatePrimitive = string | number | boolean;
 ...
 * @public
 */
interface ReadFilterPredicateFromConfigOptions {
    /**
 ...
 * @public
 */
declare function readFilterPredicateFromConfig(config: Config, options?: ReadFilterPredicateFromConfigOptions): FilterPredicate;
/**
 * Read an optional filter predicate expression from a config object.
 *
 * @public
 */
declare function readOptionalFilterPredicateFromConfig(config: Config, options?: ReadFilterPredicateFromConfigOptions): FilterPredicate | undefined;
 ...
 * @public
 */
declare function evaluateFilterPredicate(predicate: FilterPredicate, value: unknown): boolean;
/**
 * Convert a filter predicate to a filter function.
 *
 * @public
 */
declare function filterPredicateToFilterFunction<T = unknown>(predicate: FilterPredicate): (value: T) => boolean;
 ...
 * @public
 */
declare function getJsonValueAtPath(value: JsonValue | undefined, path: string): JsonValue | undefined;
 ...
 * @public
 */
declare function createZodV3FilterPredicateSchema(z: typeof zodV3.z): zodV3.ZodType<FilterPredicate>;
/**
 ...
 */
declare function parseFilterPredicate(value: unknown): FilterPredicate;

export { createZodV3FilterPredicateSchema, evaluateFilterPredicate, filterPredicateToFilterFunction, getJsonValueAtPath, parseFilterPredicate, readFilterPredicateFromConfig, readOptionalFilterPredicateFromConfig };
export type { FilterPredicate, FilterPredicateExpression, FilterPredicatePrimitive, FilterPredicateValue, ReadFilterPredicateFromConfigOptions, UnknownFilterPredicateOperator, UnknownFilterPredicateValueMatcher };
