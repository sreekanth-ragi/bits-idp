...
const permissionCriteriaSchema = v3.z.lazy(
  () => v3.z.union([
    v3.z.object({ anyOf: v3.z.array(permissionCriteriaSchema).nonempty() }),
    v3.z.object({ allOf: v3.z.array(permissionCriteriaSchema).nonempty() }),
    v3.z.object({ not: permissionCriteriaSchema }),
    v3.z.object({
      rule: v3.z.string(),
...
const applyConditionsRequestSchema = v3.z.object({
  items: v3.z.array(
    v3.z.object({
      id: v3.z.string(),
      resourceRef: v3.z.union([v3.z.string(), v3.z.array(v3.z.string()).nonempty()]),
      resourceType: v3.z.string(),
  ...
  addPermissionRules(rules) {
    for (const rule of rules) {
      ...
      this.#serializedRules.push({
        ...
        paramsSchema: zodToJsonSchema__default.default(rule.paramsSchema ?? v3.z.object({}))
      });
    }
  }
