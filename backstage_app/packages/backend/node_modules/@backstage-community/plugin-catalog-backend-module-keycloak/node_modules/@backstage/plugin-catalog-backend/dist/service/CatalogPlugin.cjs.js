...
const catalogPlugin = backendPluginApi.createBackendPlugin({
  ...
  register(env) {
    ...
    const entityProviders = new Array();
    const placeholderResolvers = {};
    let onProcessingError = void 0;
    env.registerExtensionPoint({
      extensionPoint: pluginCatalogNode.catalogProcessingExtensionPoint,
      factory: (context) => ({
    ...
    env.registerExtensionPoint(pluginCatalogNode.catalogAnalysisExtensionPoint, {
    ...
    env.registerExtensionPoint(
      pluginCatalogNode.catalogLocationsExtensionPoint,
    ...
    env.registerInit({
      ...
      async init({
        ...
        Object.entries(placeholderResolvers).forEach(
